...
VALUES ('BIEN001', 'IMP001');-- ---------------------- LOGEMENT ----------------------
...
VALUES ('FACT001', TO_DATE('2023-10-15', 'YYYY-MM-DD'), TO_DATE('2023-10-20', 'YYYY-MM-DD'), 'Virement', 'DEV001', 'Facture de location annuelle', 1000, 1200, 1, 300, 'LOG001', 'BIEN001', '12345678901234');

INSERT INTO SAE_Facture (Id_Facture, date_emission, date_paiement, mode_paiement, numero_devis, designation, montant_reel_verse, montant, imputable_locataire, acompte_verse, Id_Logement, Id_Bien, SIRET)
VALUES ('FACT002', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TO_DATE('2023-11-05', 'YYYY-MM-DD'), 'Chèque', 'DEV002', 'Facture pour travaux de rénovation', 500, 800, 0, 200, 'LOG002', 'BIEN002', '98765432109876');

INSERT INTO SAE_Facture (Id_Facture, date_emission, date_paiement, mode_paiement, numero_devis, designation, montant_reel_verse, montant, imputable_locataire, acompte_verse, Id_Logement, Id_Bien, SIRET)
VALUES ('FACT003', TO_DATE('2023-12-15', 'YYYY-MM-DD'), TO_DATE('2023-12-20', 'YYYY-MM-DD'), 'Espèces', 'DEV003', 'Facture de charges mensuelles', 200, 400, 1, 100, 'LOG003', 'BIEN003', '45678912345678');
...
VALUES ('BIEN001', 'LOC001', TO_DATE('2023-01-01', 'YYYY-MM-DD'), 12, 1200, 150, 1000, 'Bail de location annuelle', 'Bon état', 1200, '2023', '1');

INSERT INTO SAE_Louer (Id_Bien, Id_Locataire, Date_debut, nb_mois, loyer_payer, provisions_chargesMois_TTC, caution_TTC, bail, etat_lieux, montant_reel_payer, annee, trimestre)
VALUES ('BIEN002', 'LOC002', TO_DATE('2023-06-01', 'YYYY-MM-DD'), 6, 600, 75, 500, 'Bail de location pour 6 mois', 'Très bon état', 600, '2023', '2');

INSERT INTO SAE_Louer (Id_Bien, Id_Locataire, Date_debut, nb_mois, loyer_payer, provisions_chargesMois_TTC, caution_TTC, bail, etat_lieux, montant_reel_payer, annee, trimestre)
VALUES ('BIEN003', 'LOC003', TO_DATE('2023-09-01', 'YYYY-MM-DD'), 12, 800, 100, 700, 'Bail de location annuelle', 'Bon état', 800, '2023', '3');

-- ---------------------- CHARGE ----------------------
INSERT INTO SAE_Charge (Id_Charges, nom, montant_reel, montant_previsionnel, deductible, date_charge, Id_Bien)
VALUES ('CHARGE001', 'Eau', 150, 200, 1, TO_DATE('2023-10-01', 'YYYY-MM-DD'), 'BIEN001');

INSERT INTO SAE_Charge (Id_Charges, nom, montant_reel, montant_previsionnel, deductible, date_charge, Id_Bien)
VALUES ('CHARGE002', 'Electricité', 300, 350, 0, TO_DATE('2023-10-10', 'YYYY-MM-DD'), 'BIEN002');

INSERT INTO SAE_Charge (Id_Charges, nom, montant_reel, montant_previsionnel, deductible, date_charge, Id_Bien)
VALUES ('CHARGE003', 'Entretien', 200, 250, 1, TO_DATE('2023-11-01', 'YYYY-MM-DD'), 'BIEN003');

-- ---------------------- COMPTEUR ----------------------
INSERT INTO SAE_Compteur (Id_Compteur, TypeComp, indexCompteur, date_releve, Id_Logement, Id_Bien)
VALUES ('COMP001', 'Eau', 100, TO_DATE('2023-10-01', 'YYYY-MM-DD'), 'LOG001', 'BIEN001');

INSERT INTO SAE_Compteur (Id_Compteur, TypeComp, indexCompteur, date_releve, Id_Logement, Id_Bien)
VALUES ('COMP002', 'Gaz', 50, TO_DATE('2023-10-15', 'YYYY-MM-DD'), 'LOG002', 'BIEN002');

INSERT INTO SAE_Compteur (Id_Compteur, TypeComp, indexCompteur, date_releve, Id_Logement, Id_Bien)
VALUES ('COMP003', 'Electricité', 150, TO_DATE('2023-11-01', 'YYYY-MM-DD'), 'LOG003', 'BIEN003');
