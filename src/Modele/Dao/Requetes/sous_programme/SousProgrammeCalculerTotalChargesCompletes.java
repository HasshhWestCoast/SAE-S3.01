...
/**
 * Classe pour appeler la fonction PL/SQL `CalculerTotalChargesCompletes`.
 */
public class SousProgrammeCalculerTotalChargesCompletes implements SousProgramme<String> {

    @Override
    public String appelSousProgramme() {
        // Requête pour appeler la fonction `CalculerTotalChargesCompletes`
        return "{ ? = call CalculerTotalChargesCompletes(?) }";
    }
