...
/**
 * Classe pour appeler la fonction PL/SQL `CalculDuLoyer`.
 */
public class SousProgrammeCalculDuLoyer implements SousProgramme<String> {

    @Override
    public String appelSousProgramme() {
        // Requête pour appeler la fonction `CalculDuLoyer`
        return "{ ? = call CalculDuLoyer(?) }";
    }
