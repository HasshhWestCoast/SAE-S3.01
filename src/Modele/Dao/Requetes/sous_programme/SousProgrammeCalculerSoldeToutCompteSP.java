...
/**
 * Classe pour appeler la fonction PL/SQL `CalculerSoldeToutCompte_SP`.
 */
public class SousProgrammeCalculerSoldeToutCompteSP implements SousProgramme<String> {

    @Override
    public String appelSousProgramme() {
        // Requête pour appeler la fonction `CalculerSoldeToutCompte_SP`
        return "{ ? = call CalculerSoldeToutCompte_SP(?) }";
    }
