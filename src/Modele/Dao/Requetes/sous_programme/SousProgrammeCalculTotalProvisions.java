...
/**
 * Classe pour appeler la fonction PL/SQL `CalculTotalProvisions`.
 */
public class SousProgrammeCalculTotalProvisions implements SousProgramme<String> {

    @Override
    public String appelSousProgramme() {
        // Requête pour appeler la fonction `CalculTotalProvisions`
        return "{ ? = call CalculTotalProvisions(?) }";
    }
