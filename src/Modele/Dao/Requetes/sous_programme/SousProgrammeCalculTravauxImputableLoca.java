...
/**
 * Classe pour appeler la fonction PL/SQL `CalculTravauxImputableLoca`.
 */
public class SousProgrammeCalculTravauxImputableLoca implements SousProgramme<String> {

    @Override
    public String appelSousProgramme() {
        // Requête pour appeler la fonction `CalculTravauxImputableLoca`
        return "{ ? = call CalculTravauxImputableLoca(?) }";
    }
