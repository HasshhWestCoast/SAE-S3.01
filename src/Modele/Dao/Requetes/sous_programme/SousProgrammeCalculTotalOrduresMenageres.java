...
/**
 * Classe pour appeler la fonction PL/SQL `CalcultotalOrduresMenageres`.
 */
public class SousProgrammeCalculTotalOrduresMenageres implements SousProgramme<String> {

    @Override
    public String appelSousProgramme() {
        // Requête pour appeler la fonction `CalcultotalOrduresMenageres`
        return "{ ? = call CalcultotalOrduresMenageres(?) }";
    }
